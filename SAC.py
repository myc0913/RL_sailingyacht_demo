...
class SAC_countinuous():
	def __init__(self, **kwargs):
		...
		self.actor = Actor(self.state_dim, self.action_dim, (self.net_width,self.net_width,128)).to(self.dvc)
		self.actor_optimizer = torch.optim.Adam(self.actor.parameters(), lr=self.a_lr)

		self.q_critic = Double_Q_Critic(self.state_dim, self.action_dim, (self.net_width,self.net_width,128),(self.net_width,self.net_width,128)).to(self.dvc)
